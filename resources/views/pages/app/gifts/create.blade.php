...
@section('content')
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {{-- Cột Form Nhập Liệu (Tự động sinh từ JSON Schema) --}}
            <div class="lg:col-span-5 xl:col-span-4 bg-white dark:bg-surface-dark border border-slate-200 dark:border-border-dark rounded-2xl shadow-sm overflow-hidden sticky top-24">
                ...
                <form method="POST" action="{{ route('app.gifts.store', $template->slug) }}" class="p-5 flex flex-col gap-5">
                    @csrf
                    ...
                    @foreach($template->getSchemaFields() as $field)
                        @php
                            ...
                            // Ưu tiên giá trị old, nếu không có thì lấy giá trị default từ schema
                    ...
                    <div class="mt-4 pt-5 border-t border-slate-100 dark:border-border-dark">
                        ...
                        <p class="text-center w-full text-xs text-slate-500 mt-3 font-medium flex items-center justify-center gap-1">
